...
And much more! I recommend checking out our Cypress tests in `cypress/fixtures/specs`, then reading through at least these sections of the excellent Cypress docs:
